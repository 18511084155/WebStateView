package com.woodys.stateview.widget;
...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation(Context context, AttributeSet attrs) {
        ...
        mFromDegrees = a.getFloat(R.styleable.Rotate3dAnimation_r3a_fromDeg, 0.0f);
        mToDegrees = a.getFloat(R.styleable.Rotate3dAnimation_r3a_toDeg, 0.0f);
        mRollType = a.getInt(R.styleable.Rotate3dAnimation_r3a_rollType, ROLL_BY_X);
        Description d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_r3a_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_r3a_pivotY));
        mPivotYType = d.type;
